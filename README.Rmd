...
You can install the development version of readHCUP from [GitHub](https://github.com/) with:
...
-   Note: In order for the corrections to be applied, `KEY_NIS` needs to be included in your dataset. If `KEY_NIS` is not included, `read_nis()` will still return the data and you will receive a warning that corrections were not applied.

If for some reason you don't want the corrections to be automatically applied, use `corrected = FALSE`:
